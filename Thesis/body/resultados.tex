...
$T_{I}(n)$ é calculada para todos os rankings entre 1 e 30, uma vez que este revelou ser o intervalo com informação mais significativa para os conjuntos de teste utilizados. Os primeiros níveis de ranking apresentam, naturalmente, uma maior variação na percentagem de pessoas identificadas, revelando-se assim como mais significativos para a análise do desempenho do sistema.
