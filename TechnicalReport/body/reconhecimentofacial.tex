...
\subsection{Sub-Problemas} \label{sec:solucao}
...
\subsection{Segurança e Reforço da Lei} \label{sec:SegurancaReforcoLei}
...
\section{Evolução Desempenho}\label{sec:performance}
