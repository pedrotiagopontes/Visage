...
%%----------------------------------------
\title{Visage} 
\title{Impacto dos Filtros de Abstração no Reconhecimento Facial em Imagens}
...
\include{body/introducao}
\include{body/reconhecimentofacial}
\include{body/abstracaoimagens}
\include{body/perspectivasolucao}
\include{body/conclusoes} 
